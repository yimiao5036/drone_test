...
echo "香橙派程序 config.json 的 video.output_rtsp 应为:"
echo "  rtsp://127.0.0.1:8554/drone_out"
echo "图传设备/地面端拉取地址:"
echo "  rtsp://<香橙派IP>:8554/drone_out"
echo "  可用命令查看对外 IP: ip -br addr | grep 144"
echo "本机验证拉流:  ffplay rtsp://127.0.0.1:8554/drone_out"
